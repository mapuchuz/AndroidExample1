...
//			toaster();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<Animal>(getActivity(),
				android.R.layout.simple_list_item_activated_1, android.R.id.text1, AnimalContent.ITEMS));
	}
	...
	public void onListItemClick(ListView listView, View view, int position, long id) {
		...
		mCallbacks.onItemSelected(AnimalContent.ITEMS.get(position).id);
	}
	...
	public static void afficheToast() {
//		this.toaster();
	}
	public  void toaster() {
		Context context = this.getActivity().getApplicationContext();
		CharSequence text = "Hello toast in AnimalListFragment.java !";
